...
dfFacultyAvailabilityUnsorted = pd.read_excel('forBot_FacultyAvailability.xlsx', index_col=0).fillna(0).transpose()
...
dfStudentRequestsUnsorted = pd.read_excel('forBot_StudentRequests.xlsx', index_col=0).fillna(0).transpose()
